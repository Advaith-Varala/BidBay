...
async function profile() {
  await fetch(`https://bidbay-1-sbac.onrender.com/users/${userId}`, {
    method: "get",
    headers: {
...
const getUsers = async () => {
  await fetch(`https://bidbay-1-sbac.onrender.com/users`, {
    method: "get",
    headers: {
      "Content-Type": "application/json",
    },
...
async function fetchBidClose(bidUserId, bidAmount) {
  ...
  await fetch(`https://bidbay-1-sbac.onrender.com/users?id=${bidUserId}`, {
    method: "get",
    headers: {
      "Content-Type": "application/json",
    },
    ...
    .then(async (data) => {
      ...
      await fetch(`https://bidbay-1-sbac.onrender.com/bids/${bidData.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      // Then Update Amount
      await fetch(`https://bidbay-1-sbac.onrender.com/users/${user.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
